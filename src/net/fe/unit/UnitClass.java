...
public final class UnitClass implements Serializable {
	 ...
	 */
	private UnitClass(String name, String desc, int c, CombatTrigger m, List<? extends FieldSkill> fs, Weapon.Type... types){
		this.crit = c;
		this.masterSkill = m;
	...
	public static UnitClass createClass(String name){
		...
		if(name.equals("Swordmaster"))
			return new UnitClass("Swordmaster",
		...
		if(name.equals("Falconknight"))
			return new UnitClass("Falconknight", 
